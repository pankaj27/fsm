...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2018 at 03:12 AM
...
--
-- Database: `co-operative-management`
--
...
INSERT INTO `account_master` (`id`, `accname`, `code`, `crtdby`, `status`, `updateby`) VALUES
(1, 'RECURRING DEPOSIT ', 'RD', 4, 1, 4),
(2, 'SAVINGS & CURRENT ACCOUNT ', 'S/B AC', 4, 0, 4),
(3, 'LOAN ACCOUNT', 'LC', 4, 0, 4);
...
--
-- Table structure for table `customer_contact_master`
--
...
--
-- Dumping data for table `customer_contact_master`
--

INSERT INTO `customer_contact_master` (`id`, `accno`, `customer_id`, `address`, `state`, `district`, `pincode`, `crtdby`, `updateby`, `doe`, `status`) VALUES
(4, '101', 4, 'VVC', 'WEST BENGAL', 'Howrah', '1234567', '4', '4', '2018-02-15 03:23:29', 1),
(5, '103', 5, 'HGHJ', 'WEST BENGAL', 'Howrah', '7216481', '4', '', '2018-02-27 16:23:47', 1),
(6, '3703', 6, 'SHYAMPUR', 'WEST BENGAL', 'Howrah', '7113140', '4', '4', '2018-03-18 19:57:51', 1);

-- --------------------------------------------------------

--
-- Table structure for table `customer_loan_master`
--

CREATE TABLE `customer_loan_master` (
  `id` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `loan_amount` decimal(11,2) NOT NULL,
  `loan_date` varchar(50) NOT NULL,
  `monthly_installment` decimal(11,2) NOT NULL,
  `period` varchar(255) NOT NULL,
  `interest_calculate` varchar(255) NOT NULL,
  `interest_rate` decimal(11,2) NOT NULL,
  `loan_adjust_date` varchar(255) NOT NULL,
  `loan_txt` longtext NOT NULL,
  `crtdby` varchar(11) NOT NULL,
  `updateby` varchar(11) NOT NULL,
  `doe` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` int(11) NOT NULL DEFAULT '1'
...
--
-- Dumping data for table `customer_loan_master`
--

INSERT INTO `customer_loan_master` (`id`, `accno`, `customer_id`, `loan_amount`, `loan_date`, `monthly_installment`, `period`, `interest_calculate`, `interest_rate`, `loan_adjust_date`, `loan_txt`, `crtdby`, `updateby`, `doe`, `status`) VALUES
(3, '101', 4, '35000.00', '', '0.00', '', '', '0.00', '', '{10000,04/07/2018,200.00,18,2,Monthly,07-10-2019},,,,,,,,', '4', '4', '2018-03-28 20:44:58', 2),
(4, '103', 5, '10000.00', '01/22/2018', '270.00', '18', 'Monthly', '5.00', '22-09-2019', 'Array', '4', '4', '2018-03-28 20:50:31', 2),
(6, '3703', 6, '170000.00', '09/26/2016', '2000.00', '18', 'Monthly', '2.00', '26-03-2018', 'Array,50000,08/10/2016,1000.00,18,2,Monthly,10-02-2018,50000,08/10/2016,1000.00,18,2,Monthly,10-02-2018,100000,09/26/2016,2000.00,18,2,Monthly,26-03-2018', '4', '4', '2018-03-19 02:13:52', 1);
...
CREATE TABLE `customer_master` (
  ...
  `maritorial_status` enum('Yes','No','Others','') NOT NULL,
  `joint_holder1` varchar(255) NOT NULL,
  `joint_holder2` varchar(255) NOT NULL,
  `nominee` varchar(255) NOT NULL,
  `relation_nominee` varchar(255) NOT NULL,
  `crtdby` varchar(11) NOT NULL,
  `updateby` varchar(11) NOT NULL,
  `doe` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` int(11) NOT NULL DEFAULT '1'
...
INSERT INTO `customer_master` (`id`, `accno`, `first_name`, `middle_name`, `last_name`, `dob`, `nationality`, `gender`, `mobile`, `father_husband_name`, `mother_name`, `maritorial_status`, `joint_holder1`, `joint_holder2`, `nominee`, `relation_nominee`, `crtdby`, `updateby`, `doe`, `status`) VALUES
(4, '101', 'CXCX', '', 'XCXC', '01/31/2018', 'Others', 'Male', '1234567890', '', '', 'No', '', '', '', '', '4', '4', '2018-02-13 18:03:46', 1),
(5, '103', 'JHGJ', '', 'BJH', '02/01/2018', 'Indian', 'Male', '9800743629', '', '', 'No', '', '', '', '', '4', '', '2018-02-27 16:23:46', 1),
(6, '3703', 'ASIT', '', 'MONDAL', '10/25/1995', 'Indian', 'Male', '9800743629', '', '', 'No', '', '', '', '', '4', '4', '2018-03-18 19:57:51', 1);

-- --------------------------------------------------------

--
-- Table structure for table `customer_recurring_master`
--

CREATE TABLE `customer_recurring_master` (
  `id` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
  `customer_id` int(11) NOT NULL,
  ...
  `maturity_amount` decimal(11,2) NOT NULL,
  `tranfer_from_loan_acc` decimal(11,2) NOT NULL,
  `crtdby` varchar(11) NOT NULL,
  `updateby` varchar(11) NOT NULL,
  `doe` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` int(11) NOT NULL DEFAULT '1'
...
--
-- Dumping data for table `customer_recurring_master`
--

INSERT INTO `customer_recurring_master` (`id`, `accno`, `customer_id`, `opening_balance`, `opening_date`, `monthly_installment`, `period`, `interest_rate`, `maturity_date`, `maturity_amount`, `tranfer_from_loan_acc`, `crtdby`, `updateby`, `doe`, `status`) VALUES
(3, '101', 4, '0.00', '01/01/2018', '10.00', '12', '5.00', '01-01-2019', '0.00', '5100.00', '4', '4', '2018-04-01 15:55:40', 2),
(4, '103', 5, '500.00', '02/01/2018', '10.00', '12', '5.00', '01-02-2019', '0.00', '161.97', '4', '', '2018-03-18 19:09:41', 1),
(5, '3703', 6, '500.00', '03/27/2018', '10.00', '18', '4.00', '27-09-2019', '0.00', '0.00', '4', '4', '2018-03-18 19:57:51', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dd_settlement`
--

CREATE TABLE `dd_settlement` (
  `id` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
  `totdd` decimal(11,2) NOT NULL,
  `interest` decimal(11,2) NOT NULL,
  `totpay` decimal(11,2) NOT NULL,
  `othepay` decimal(11,2) NOT NULL,
  `doe` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` int(11) NOT NULL DEFAULT '1',
  `crtdby` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `dd_settlement`
--

INSERT INTO `dd_settlement` (`id`, `accno`, `totdd`, `interest`, `totpay`, `othepay`, `doe`, `status`, `crtdby`) VALUES
(2, '101', '1559.00', '14.83', '6673.83', '5100.00', '2018-03-30 05:00:08', 1, 4);
...
CREATE TABLE `insurance_master` (
  ...
  `customer_id` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
  `insurance_rate` decimal(11,2) NOT NULL,
  `insurance_amount` decimal(11,2) NOT NULL,
  `crtdby` int(11) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1',
...
INSERT INTO `insurance_master` (`id`, `customer_id`, `accno`, `insurance_rate`, `insurance_amount`, `crtdby`, `status`, `paid`, `updateby`, `doe`) VALUES
(1, 4, '101', '2.00', '400.00', 4, 1, 'Y', 4, '2018-03-18 17:35:43'),
(2, 5, '103', '1.00', '150.00', 4, 1, 'Y', 4, '2018-03-18 17:41:17'),
(4, 4, '101', '1.00', '100.00', 4, 1, 'Y', 0, '2018-03-18 17:37:48'),
(5, 4, '101', '1.00', '50.00', 4, 1, 'Y', 0, '2018-03-18 17:40:28'),
(6, 5, '103', '1.00', '54.00', 4, 1, 'Y', 0, '2018-03-18 17:42:00'),
(7, 6, '3703', '1.00', '0.00', 4, 1, 'N', 4, '2018-03-18 19:57:51'),
(8, 6, '3703', '1.00', '700.00', 4, 1, 'N', 0, '2018-03-18 19:58:32'),
(9, 6, '3703', '1.00', '500.00', 4, 1, 'N', 0, '2018-03-18 20:07:45'),
(10, 6, '3703', '1.00', '1000.00', 4, 1, 'N', 0, '2018-03-19 02:13:53');

-- --------------------------------------------------------

--
-- Table structure for table `interest_calculate`
--

CREATE TABLE `interest_calculate` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `interest_calculate`
--

INSERT INTO `interest_calculate` (`id`, `name`, `crtdby`, `status`) VALUES
(1, 'Monthly', 4, 1),
(2, 'Yearly', 4, 1);
...
CREATE TABLE `loan_master` (
  ...
  `for_the_month` int(11) NOT NULL,
  `principal` decimal(20,2) NOT NULL,
  `principal_add` decimal(11,2) NOT NULL,
  `principal_received` decimal(20,2) NOT NULL,
  `principal_due` decimal(20,2) NOT NULL,
  `monthly_interest` decimal(20,2) NOT NULL,
...
INSERT INTO `loan_master` (`loan_id`, `cid`, `accno`, `fyear`, `last_update`, `for_the_month`, `principal`, `principal_add`, `principal_received`, `principal_due`, `monthly_interest`, `interest_received`, `interest_due`, `total`, `deposit_by`, `collected_by`, `doe`, `status`, `approve`) VALUES
(8, 4, '101', 2018, '01-02-2018', 2, '20000.00', '0.00', '0.00', '20000.00', '400.00', '300.00', '100.00', '300.00', 'pkp', 'pkp', '2018-02-19 17:15:49', 1, 'Yes'),
(9, 4, '101', 2018, '03-03-2018', 3, '20000.00', '0.00', '0.00', '20000.00', '500.00', '500.00', '0.00', '500.00', 'pkp', 'pkp', '2018-02-19 17:15:49', 1, 'Yes'),
(15, 4, '101', 2018, '20-04-2018', 4, '20000.00', '0.00', '100.00', '19900.00', '400.00', '400.00', '0.00', '500.00', 'kk', 'kk', '2018-02-19 18:10:16', 1, 'Yes'),
(16, 4, '101', 2018, '18-05-2018', 5, '35000.00', '0.00', '19701.00', '199.00', '597.00', '597.00', '0.00', '20400.00', 'pkp', 'pkp', '2018-03-18 14:16:44', 1, 'Yes'),
(17, 5, '103', 2018, '01-02-2018', 2, '0.00', '0.00', '0.00', '10000.00', '500.00', '500.00', '0.00', '500.00', 'pankaj', 'sougata', '2018-03-18 14:43:49', 1, 'Yes'),
(18, 5, '103', 2018, '01-03-2018', 3, '10000.00', '0.00', '1000.00', '9000.00', '500.00', '500.00', '0.00', '1500.00', 'pankaj', 'sougata', '2018-03-18 14:43:49', 1, 'Yes'),
(19, 5, '103', 2018, '12-04-2018', 4, '10000.00', '0.00', '1050.00', '7950.00', '450.00', '450.00', '0.00', '1500.00', 'pankaj', 'sougata', '2018-03-18 14:43:49', 1, 'Yes'),
(20, 5, '103', 2018, '18-05-2018', 5, '10000.00', '0.00', '1602.50', '6347.50', '397.50', '397.50', '0.00', '2000.00', 'pankaj', 'sougata', '2018-03-18 14:43:49', 1, 'Yes'),
(21, 5, '103', 2018, '21-06-2018', 6, '10000.00', '0.00', '3682.63', '2664.88', '317.38', '317.38', '0.00', '4000.00', 'pankaj', 'sougata', '2018-03-18 14:56:33', 1, 'Yes'),
(22, 5, '103', 2018, '20-07-2018', 7, '10000.00', '0.00', '1866.76', '798.12', '133.24', '133.24', '0.00', '2000.00', 'pankaj', 'sougata', '2018-03-18 14:57:28', 1, 'Yes'),
(26, 5, '103', 2018, '02-08-2018', 8, '0.00', '0.00', '798.12', '0.00', '39.91', '39.91', '0.00', '838.03', 'pankaj', 'sougata', '2018-03-18 19:17:14', 1, 'Yes'),
(27, 6, '3703', 2016, '07-04-2016', 4, '70000.00', '0.00', '0.00', '70000.00', '1400.00', '1400.00', '0.00', '1400.00', 'pk', 'pk', '2018-03-18 20:00:43', 1, 'Yes'),
(28, 6, '3703', 2016, '02-05-2016', 5, '70000.00', '0.00', '100.00', '69900.00', '1400.00', '1400.00', '0.00', '1500.00', 'pk', 'pk', '2018-03-18 20:00:43', 1, 'Yes'),
(34, 6, '3703', 2016, '14-07-2016', 7, '70000.00', '0.00', '8704.00', '61196.00', '1398.00', '2796.00', '0.00', '11500.00', 'pk', 'pk', '2018-03-19 02:49:55', 1, 'Yes'),
(36, 6, '3703', 2016, '12-08-2016', 8, '70000.00', '0.00', '14276.00', '46920.00', '1224.00', '1224.00', '0.00', '15500.00', 'pk', 'pk', '2018-03-19 02:09:07', 1, 'Yes'),
(37, 6, '3703', 2016, '09/26/2016', 9, '0.00', '100000.00', '0.00', '146920.00', '0.00', '0.00', '0.00', '0.00', '', '', '2018-03-19 02:51:33', 2, 'Yes'),
(41, 6, '3703', 2016, '23-09-2016', 9, '170000.00', '0.00', '12062.00', '134858.00', '2938.00', '2938.00', '0.00', '15000.00', 'pk', 'pk', '2018-03-19 02:37:19', 1, 'Yes'),
(42, 6, '3703', 2016, '21-10-2016', 10, '170000.00', '0.00', '12303.00', '122555.00', '2697.00', '2697.00', '0.00', '15000.00', 'pk', 'pk', '2018-03-19 02:40:48', 1, 'Yes'),
(43, 6, '3703', 2016, '17-11-2016', 11, '170000.00', '0.00', '11549.00', '111006.00', '2451.00', '2451.00', '0.00', '14000.00', 'pk', 'pk', '2018-03-19 02:40:48', 1, 'Yes'),
(44, 6, '3703', 2016, '22-12-2016', 12, '170000.00', '0.00', '13280.00', '97726.00', '2220.00', '2220.00', '0.00', '15500.00', 'pk', 'pk', '2018-03-19 02:40:48', 1, 'Yes');
...
CREATE TABLE `loan_settlement` (
  ...
  `type_of_settlement` int(11) NOT NULL,
  `due_amount` decimal(11,2) NOT NULL,
  `ultimate_pay` decimal(11,2) NOT NULL,
...
INSERT INTO `loan_settlement` (`id`, `accno`, `loanamount`, `period`, `interest`, `total_paid`, `type_of_settlement`, `due_amount`, `ultimate_pay`, `deduct_from`, `paid_by`, `status`, `crtdby`) VALUES
(3, '101', '35000.00', 48, '1797.00', '19801.00', 3, '15502.98', '5400.00', '', '', 2, 4),
(4, '103', '20400.00', 30, '2338.03', '10000.01', 4, '0.00', '10399.99', 'Insurance', '', 2, 4);

-- --------------------------------------------------------

--
-- Table structure for table `loan_take`
--

CREATE TABLE `loan_take` (
  `id` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `loan_amount` decimal(11,2) NOT NULL,
...
--
-- Dumping data for table `loan_take`
--

INSERT INTO `loan_take` (`id`, `accno`, `customer_id`, `loan_amount`, `loan_date`, `monthly_installment`, `period`, `interest_calculate`, `interest_rate`, `loan_adjust_date`, `crtdby`, `updateby`, `doe`, `status`) VALUES
(3, '101', 4, '20000.00', '02/01/2018', '400.00', '12', 'Monthly', '2.00', '01-02-2019', '4', '4', '2018-02-20 16:28:30', 1),
(4, '103', 5, '15000.00', '02/02/2018', '300.00', '12', 'Monthly', '2.00', '27-02-2018', '4', '4', '2018-02-27 16:24:39', 1),
(7, '101', 4, '10000.00', '04/07/2018', '200.00', '18', 'Monthly', '2.00', '07-10-2019', '4', '4', '2018-03-18 07:19:24', 1),
(8, '101', 4, '5000.00', '03/31/2018', '150.00', '18', 'Monthly', '3.00', '01-10-2019', '4', '4', '2018-03-18 07:22:17', 1),
(9, '103', 5, '5400.00', '03/22/2018', '270.00', '18', 'Monthly', '5.00', '22-09-2019', '4', '4', '2018-03-18 07:24:20', 1),
(10, '3703', 6, '70000.00', '04/07/2016', '1400.00', '18', 'Monthly', '2.00', '07-10-2017', '4', '4', '2018-03-18 19:58:32', 1),
(12, '3703', 6, '100000.00', '09/26/2016', '2000.00', '18', 'Monthly', '2.00', '26-03-2018', '4', '4', '2018-03-19 02:13:53', 1);
...
--
-- Table structure for table `recurring_master`
--

CREATE TABLE `recurring_master` (
  `recurring_id` int(20) NOT NULL,
  `cid` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
  ...
  `balance_with_interest` decimal(11,2) NOT NULL,
  `deposit_by` varchar(255) NOT NULL,
  `collected_by` varchar(255) NOT NULL,
  `doe` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `status` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `recurring_master`
--

INSERT INTO `recurring_master` (`recurring_id`, `cid`, `accno`, `fyear`, `last_update`, `for_the_month`, `amount_paid`, `balance`, `balance_with_interest`, `deposit_by`, `collected_by`, `doe`, `status`, `approve`) VALUES
(3, 4, '101', '2018', '03-01-2018', 1, '400.00', '400.00', '0.00', 'Sougata', 'Pankaj', '2018-02-02 17:30:07', 0, 'Yes'),
(4, 4, '101', '2018', '09-02-2018', 2, '559.00', '959.00', '0.00', 'gg', 'hh', '2018-02-17 06:35:05', 0, 'Yes'),
(5, 4, '101', '2016', '07-01-2016', 1, '400.00', '400.00', '0.00', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 0, 'Yes'),
(6, 4, '101', '2017', '15-08-2017', 8, '200.00', '200.00', '0.00', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 0, 'Yes'),
(7, 5, '103', '2018', '01-03-2018', 3, '300.00', '300.00', '0.00', 'pankaj', 'sougata', '2018-03-18 14:51:32', 0, 'Yes');
...
CREATE TABLE `settings` (
  ...
  `is_active` enum('yes','no','warning','') NOT NULL DEFAULT '',
...
--
-- Table structure for table `settlement_from_insurance`
--

CREATE TABLE `settlement_from_insurance` (
  `id` int(11) NOT NULL,
  `accno` varchar(255) NOT NULL,
...
--
-- Dumping data for table `settlement_from_insurance`
--

INSERT INTO `settlement_from_insurance` (`id`, `accno`, `amount`, `note`, `status`, `crtdby`) VALUES
(1, '103', '10399.99', '', 1, 4);
...
INSERT INTO `state` (`id`, `State`, `District`, `Code`, `Headquarters`) VALUES
(1, 'Rajasthan (RJ)', 'Jaipur', 'JP', 'Jaipur'),
(2, 'Bihar (BR)', 'Siwan', 'SW', 'Siwan'),
(3, 'Rajasthan (RJ)', 'Nagaur', 'NA', 'Nagaur'),
(4, 'Kerala (KL)', 'Thiruvananthapuram', 'TV', 'Thiruvananthapuram'),
(5, 'Kerala (KL)', 'Ernakulam', 'ER', 'Kakkanad'),
(6, 'Bihar (BR)', 'Purnia', 'PU', 'Purnia'),
(7, 'Madhya Pradesh (MP)', 'Indore', 'IN', 'Indore'),
(8, 'Uttar Pradesh (UP)', 'Barabanki', 'BB', 'Barabanki'),
(9, 'Uttar Pradesh (UP)', 'Ballia', 'BL', 'Ballia'),
(10, 'Uttar Pradesh (UP)', 'Pratapgarh', 'PR', 'Pratapgarh'),
(11, 'Gujarat (GJ)', 'Rajkot', 'RA', 'Rajkot'),
(12, 'Maharashtra (MH)', 'Nashik', 'NS', 'Nashik'),
(13, 'Maharashtra (MH)', 'Mumbai City', 'MC', ' —'),
(14, 'Gujarat (GJ)', 'Banaskantha', 'BK', 'Palanpur'),
(15, 'Uttar Pradesh (UP)', 'Unnao', 'UN', 'Unnao'),
(16, 'Kerala (KL)', 'Thrissur', 'TS', 'Thrissur'),
(17, 'Uttar Pradesh (UP)', 'Deoria', 'DE', 'Deoria'),
(18, 'Kerala (KL)', 'Kozhikode', 'KZ', 'Kozhikode'),
(19, 'Tamil Nadu (TN)', 'Tirunelveli', 'TI', 'Tirunelveli'),
(20, 'Bihar (BR)', 'Katihar', 'KT', 'Katihar'),
(21, 'Rajasthan (RJ)', 'Udaipur', 'UD', 'Udaipur'),
(22, 'Bihar (BR)', 'Bhagalpur', 'BG', 'Bhagalpur'),
(23, 'Uttar Pradesh (UP)', 'Allahabad', 'AH', 'Allahabad'),
(24, 'Telangana (TS)', 'Medak', 'ME', 'Sangareddi'),
(25, 'Maharashtra (MH)', 'Satara', 'ST', 'Satara'),
(26, 'Uttar Pradesh (UP)', 'Shahjahanpur', 'SJ', 'Shahjahanpur'),
(27, 'West Bengal (WB)', 'Uttar Dinajpur', 'UD', 'Raiganj'),
(28, 'Karnataka (KA)', 'Mysore', 'MY', 'Mysore'),
(29, 'Andhra Pradesh (AP)', 'Sri Potti Sriramulu Nellore', 'NE', 'Nellore'),
(30, 'Bihar (BR)', 'Rohtas', 'RO', 'Sasaram'),
(31, 'Bihar (BR)', 'Begusarai', 'BE', 'Begusarai'),
(32, 'West Bengal (WB)', 'Purulia', 'PU', 'Purulia'),
(33, 'Jharkhand (JH)', 'Ranchi', 'RA', 'Ranchi'),
(34, 'Bihar (BR)', 'Patna', 'PA', 'Patna'),
(35, 'Punjab (PB)', 'Patiala', 'PA', 'Patiala'),
(36, 'Maharashtra (MH)', 'Amravati', 'AM', 'Amravati'),
(37, 'Andhra Pradesh (AP)', 'Kadapa', 'CU', 'Kadapa'),
(38, 'Gujarat (GJ)', 'Bhavnagar', 'BV', 'Bhavnagar'),
(39, 'Bihar (BR)', 'Nalanda', 'NL', 'Bihar Sharif'),
(40, 'Tamil Nadu (TN)', 'Kanyakumari', 'KK', 'Nagercoil'),
(41, 'Assam (AS)', 'Nagaon', 'NG', 'Nagaon'),
(42, 'West Bengal (WB)', 'Cooch Behar', 'KB', 'Cooch Behar'),
(43, 'Maharashtra (MH)', 'Sangli', 'SN', 'Sangli'),
(44, 'Kerala (KL)', 'Palakkad', 'PL', 'Palakkad'),
(45, 'West Bengal (WB)', 'Hooghly', 'HG', 'Hugli-Chuchura'),
(46, 'Bihar (BR)', 'Araria', 'AR', 'Araria'),
(47, 'Telangana (TS)', 'Khammam', 'KH', 'Khammam'),
(48, 'Maharashtra (MH)', 'Yavatmal', 'YA', 'Yavatmal'),
(49, 'Gujarat (GJ)', 'Junagadh', 'JU', 'Junagadh'),
(50, 'Telangana (TS)', 'Adilabad', 'AD', 'Adilabad'),
(51, 'Delhi (DL)', 'South Delhi', 'SD', 'Saket'),
(52, 'Bihar (BR)', 'Bhojpur', 'BJ', 'Arrah'),
(53, 'Tamil Nadu (TN)', 'Tiruchirappalli', 'TC', 'Tiruchirappalli'),
(54, 'Andhra Pradesh (AP)', 'Srikakulam', 'SR', 'Srikakulam'),
(55, 'Jharkhand (JH)', 'Dhanbad', 'DH', 'Dhanbad'),
(56, 'Telangana (TS)', 'Ranga Reddy', 'RA', 'Hyderabad'),
(57, 'Karnataka (KA)', 'Tumkur', 'TU', 'Tumkur'),
(58, 'Rajasthan (RJ)', 'Sikar', 'SK', 'Sikar'),
(59, 'Uttar Pradesh (UP)', 'Maharajganj', 'MG', 'Maharajganj'),
(60, 'Chhattisgarh (CG)', 'Bilaspur', 'BI', 'Bilaspur'),
(61, 'Maharashtra (MH)', 'Raigad', 'RG', 'Alibag'),
(62, 'Uttar Pradesh (UP)', 'Fatehpur', 'FT', 'Fatehpur'),
(63, 'Kerala (KL)', 'Kollam', 'KL', 'Kollam'),
(64, 'Odisha (OD)', 'Cuttack', 'CU', 'Cuttack'),
(65, 'Rajasthan (RJ)', 'Barmer', 'BM', 'Barmer'),
(66, 'Tamil Nadu (TN)', 'Cuddalore', 'CU', 'Cuddalore'),
(67, 'West Bengal (WB)', 'Nadia', 'NA', 'Krishnanagar'),
(68, 'Maharashtra (MH)', 'Buldhana', 'BU', 'Buldhana'),
(69, 'Maharashtra (MH)', 'Beed', 'BI', 'Beed'),
(70, 'Rajasthan (RJ)', 'Ajmer', 'AJ', 'Ajmer'),
(71, 'Karnataka (KA)', 'Gulbarga', 'GU', 'Gulbarga'),
(72, 'Bihar (BR)', 'Gopalganj', 'GO', 'Gopalganj'),
(73, 'Uttar Pradesh (UP)', 'Siddharthnagar', 'SN', 'Navgarh'),
(74, 'Telangana (TS)', 'Nizamabad', 'NI', 'Nizamabad'),
(75, 'Rajasthan (RJ)', 'Bharatpur', 'BP', 'Bharatpur'),
(76, 'Uttar Pradesh (UP)', 'Mathura', 'MT', 'Mathura'),
(77, 'Karnataka (KA)', 'Bellary', 'BL', 'Bellary'),
(78, 'Andhra Pradesh (AP)', 'East Godavari', 'EG', 'Kakinada'),
(79, 'Delhi (DL)', 'West Delhi', 'WD', 'Rajouri Garden'),
(80, 'Kerala (KL)', 'Kannur', 'KN', 'Kannur'),
(81, 'Odisha (OD)', 'Mayurbhanj', 'MY', 'Baripada'),
(82, 'Bihar (BR)', 'Aurangabad', 'AU', 'Aurangabad'),
(83, 'Uttar Pradesh (UP)', 'Firozabad', 'FI', 'Firozabad'),
(84, 'Uttar Pradesh (UP)', 'Mirzapur', 'MI', 'Mirzapur'),
(85, 'Punjab (PB)', 'Amritsar', 'AM', 'Amritsar'),
(86, 'Tamil Nadu (TN)', 'Tirupur', 'TP', 'Tirupur'),
(87, 'Tamil Nadu (TN)', 'Tiruvannamalai', 'TV', 'Tiruvannaamalai'),
(88, 'Uttar Pradesh (UP)', 'Faizabad', 'FZ', 'Faizabad'),
(89, 'West Bengal (WB)', 'Paschim Medinipur', 'PM', 'Midnapore'),
(90, 'Uttar Pradesh (UP)', 'Basti', 'BS', 'Basti'),
(91, 'Madhya Pradesh (MP)', 'Jabalpur', 'JA', 'Jabalpur'),
(92, 'Maharashtra (MH)', 'Latur', 'LA', 'Latur'),
(93, 'Jharkhand (JH)', 'Giridih', 'GI', 'Giridih'),
(94, 'Gujarat (GJ)', 'Sabarkantha', 'SK', 'Himatnagar'),
(95, 'Rajasthan (RJ)', 'Bhilwara', 'BW', 'Bhilwara'),
(96, 'Tamil Nadu (TN)', 'Thanjavur', 'TJ', 'Thanjavur'),
(97, 'Uttar Pradesh (UP)', 'Ambedkar Nagar', 'AN', 'Akbarpur'),
(98, 'Gujarat (GJ)', 'Panchmahal', 'PM', 'Godhra'),
(99, 'Uttar Pradesh (UP)', 'Bahraich', 'BH', 'Bahraich'),
(100, 'Bihar (BR)', 'East Champaran', 'EC', 'Motihari'),
(101, 'Madhya Pradesh (MP)', 'Sagar', 'SG', 'Sagar'),
(102, 'Madhya Pradesh (MP)', 'Bhopal', 'BP', 'Bhopal'),
(103, 'Rajasthan (RJ)', 'Bikaner', 'BI', 'Bikaner'),
(104, 'Madhya Pradesh (MP)', 'Rewa', 'RE', 'Rewa'),
(105, 'Andhra Pradesh (AP)', 'Vizianagaram', 'VZ', 'Vizianagaram'),
(106, 'Uttar Pradesh (UP)', 'Rampur', 'RA', 'Rampur'),
(107, 'Odisha (OD)', 'Balasore', 'BW', 'Balasore'),
(108, 'Punjab (PB)', 'Gurdaspur', 'GU', 'Gurdaspur'),
(109, 'Gujarat (GJ)', 'Kheda', 'KH', 'Nadiad'),
(110, 'Delhi (DL)', 'South West Delhi', 'SW', 'Vasant Vihar'),
(111, 'West Bengal (WB)', 'North 24 Parganas', 'PN', 'Barasat'),
(112, 'Gujarat (GJ)', 'Surat', 'ST', 'Surat'),
(113, 'Jharkhand (JH)', 'East Singhbhum', 'ES', 'Jamshedpur'),
(114, 'Tamil Nadu (TN)', 'Erode', 'ER', 'Erode'),
(115, 'Odisha (OD)', 'Khordha', 'KH', 'Khordha'),
(116, 'Delhi (DL)', 'North East Delhi', 'NE', 'Shahdara'),
(117, 'Madhya Pradesh (MP)', 'Satna', 'ST', 'Satna'),
(118, 'Bihar (BR)', 'Supaul', 'SU', 'Supaul'),
(119, 'Uttar Pradesh (UP)', 'Sambhal(Bheem Nagar)', 'SM', 'Sambhal'),
(120, 'Bihar (BR)', 'Nawada', 'NW', 'Nawada'),
(121, 'Uttar Pradesh (UP)', 'Mau', 'MB', 'Mau'),
(122, 'Maharashtra (MH)', 'Chandrapur', 'CH', 'Chandrapur'),
(123, 'Andhra Pradesh (AP)', 'Guntur', 'GU', 'Guntur'),
(124, 'Madhya Pradesh (MP)', 'Dhar', 'DH', 'Dhar'),
(125, 'Punjab (PB)', 'Jalandhar', 'JA', 'Jalandhar'),
(126, 'Karnataka (KA)', 'Vijayapura', 'BJ', 'Vijayapura'),
(127, 'Tamil Nadu (TN)', 'Dindigul', 'DI', 'Dindigul'),
(128, 'Gujarat (GJ)', 'Jamnagar', 'JA', 'Jamnagar'),
(129, 'Uttar Pradesh (UP)', 'Balrampur', 'BP', 'Balrampur'),
(130, 'Rajasthan (RJ)', 'Jhunjhunu', 'JJ', 'Jhunjhunu'),
(131, 'Gujarat (GJ)', 'Dahod', 'DA', 'Dahod'),
(132, 'Kerala (KL)', 'Alappuzha', 'AL', 'Alappuzha'),
(133, 'Gujarat (GJ)', 'Kutch', 'KA', 'Bhuj'),
(134, 'West Bengal (WB)', 'Howrah', 'HR', 'Howrah'),
(135, 'Madhya Pradesh (MP)', 'Chhindwara', 'CN', 'Chhindwara'),
(136, 'Gujarat (GJ)', 'Anand', 'AN', 'Anand'),
(137, 'Karnataka (KA)', 'Dakshina Kannada', 'DK', 'Mangalore'),
(138, 'Odisha (OD)', 'Sundargarh', 'SU', 'Sundargarh'),
(139, 'Jharkhand (JH)', 'Bokaro', 'BO', 'Bokaro'),
(140, 'Maharashtra (MH)', 'Dhule', 'DH', 'Dhule'),
(141, 'Rajasthan (RJ)', 'Churu', 'CR', 'Churu'),
(142, 'Rajasthan (RJ)', 'Pali', 'PA', 'Pali'),
(143, 'Uttar Pradesh (UP)', 'Pilibhit', 'PI', 'Pilibhit'),
(144, 'Madhya Pradesh (MP)', 'Gwalior', 'GW', 'Gwalior'),
(145, 'Bihar (BR)', 'Muzaffarpur', 'MZ', 'Muzaffarpur'),
(146, 'Bihar (BR)', 'Banka', 'BA', 'Banka'),
(147, 'Gujarat (GJ)', 'Mehsana', 'MA', 'Mehsana'),
(148, 'Punjab (PB)', 'Firozpur', 'FI', 'Firozpur'),
(149, 'Uttar Pradesh (UP)', 'Jhansi', 'JH', 'Jhansi'),
(150, 'Punjab (PB)', 'Pathankot', 'PA', 'Pathankot'),
(151, 'Bihar (BR)', 'Madhepura', 'MP', 'Madhepura'),
(152, 'Madhya Pradesh (MP)', 'Ujjain', 'UJ', 'Ujjain'),
(153, 'Kerala (KL)', 'Kottayam', 'KT', 'Kottayam'),
(154, 'Rajasthan (RJ)', 'Ganganagar', 'GA', 'Ganganagar'),
(155, 'Madhya Pradesh (MP)', 'Morena', 'MO', 'Morena'),
(156, 'Karnataka (KA)', 'Belgaum', 'BG', 'Belgaum'),
(157, 'Maharashtra (MH)', 'Jalna', 'JN', 'Jalna'),
(158, 'Uttar Pradesh (UP)', 'Chandauli', 'CD', 'Chandauli'),
(159, 'Rajasthan (RJ)', 'Kota', 'KO', 'Kota'),
(160, 'Assam (AS)', 'Dhubri', 'DB', 'Dhubri'),
(161, 'Karnataka (KA)', 'Davanagere', 'DA', 'Davangere'),
(162, 'Tamil Nadu (TN)', 'Virudhunagar', 'VR', 'Virudhunagar'),
(163, 'Jharkhand (JH)', 'Palamu', 'PL', 'Daltonganj'),
(164, 'Uttarakhand (UK)', 'Haridwar', 'HA', 'Haridwar'),
(165, 'Assam (AS)', 'Sonitpur', 'SO', 'Tezpur'),
(166, 'Karnataka (KA)', 'Raichur', 'RA', 'Raichur'),
(167, 'Uttar Pradesh (UP)', 'Moradabad', 'MO', 'Moradabad'),
(168, 'Tamil Nadu (TN)', 'Pudukkottai', 'PU', 'Pudukkottai'),
(169, 'Bihar (BR)', 'Saharsa', 'SH', 'Saharsa'),
(170, 'Karnataka (KA)', 'Bagalkot', 'BK', 'Bagalkot'),
(171, 'Uttar Pradesh (UP)', 'Farrukhabad', 'FR', 'Fatehgarh'),
(172, 'Tamil Nadu (TN)', 'Krishnagiri', 'KR', 'Krishnagiri'),
(173, 'Madhya Pradesh (MP)', 'Khargone (West Nimar)', 'WN', 'Khargone'),
(174, 'Uttar Pradesh (UP)', 'Sonbhadra', 'SO', 'Robertsganj'),
(175, 'Uttar Pradesh (UP)', 'Mainpuri', 'MP', 'Mainpuri'),
(176, 'Karnataka (KA)', 'Dharwad', 'DH', 'Dharwad'),
(177, 'West Bengal (WB)', 'Darjeeling', 'DA', 'Darjeeling'),
(178, 'Tamil Nadu (TN)', 'Chennai', 'CH', 'Chennai (Madras)'),
(179, 'Uttar Pradesh (UP)', 'Jyotiba Phule Nagar', 'JP', 'Amroha'),
(180, 'Maharashtra (MH)', 'Parbhani', 'PA', 'Parbhani'),
(181, 'Rajasthan (RJ)', 'Jalore', 'JL', 'Jalore'),
(182, 'Odisha (OD)', 'Jajpur', 'JP', 'Panikoili'),
(183, 'Maharashtra (MH)', 'Akola', 'AK', 'Akola'),
(184, 'Karnataka (KA)', 'Mandya', 'MA', 'Mandya'),
(185, 'Odisha (OD)', 'Kendujhar (Keonjhar)', 'KJ', 'Kendujhar'),
(186, 'Uttar Pradesh (UP)', 'Banda', 'BN', 'Banda'),
(187, 'Haryana (HR)', 'Faridabad', 'FR', 'Faridabad'),
(188, 'Rajasthan (RJ)', 'Banswara', 'BN', 'Banswara'),
(189, 'Uttar Pradesh (UP)', 'Ghaziabad', 'GZ', 'Ghaziabad'),
(190, 'Uttar Pradesh (UP)', 'Kanpur Dehat (Ramabai Nagar)', 'KD', 'Akbarpur (Mati)'),
(191, 'Rajasthan (RJ)', 'Hanumangarh', 'HA', 'Hanumangarh'),
(192, 'Karnataka (KA)', 'Hassan', 'HS', 'Hassan'),
(193, 'Madhya Pradesh (MP)', 'Chhatarpur', 'CT', 'Chhatarpur'),
(194, 'Uttar Pradesh (UP)', 'Etah', 'ET', 'Etah'),
(195, 'Bihar (BR)', 'Jamui', 'JA', 'Jamui'),
(196, 'Gujarat (GJ)', 'Surendranagar', 'SN', 'Surendranagar'),
(197, 'Karnataka (KA)', 'Shimoga', 'SH', 'Shimoga'),
(198, 'Haryana (HR)', 'Hissar', 'HI', 'Hissar'),
(199, 'Tamil Nadu (TN)', 'Thoothukudi', 'TK', 'Thoothukudi (Tuticorin)'),
(200, 'Maharashtra (MH)', 'Nagpur', 'NG', 'Nagpur'),
(201, 'Assam (AS)', 'Cachar', 'CA', 'Silchar'),
(202, 'Jharkhand (JH)', 'Hazaribag', 'HA', 'Hazaribag'),
(203, 'Madhya Pradesh (MP)', 'Shivpuri', 'SV', 'Shivpuri'),
(204, 'Tamil Nadu (TN)', 'Namakkal', 'NM', 'Namakkal'),
(205, 'Uttar Pradesh (UP)', 'Sant Kabir Nagar', 'SK', 'Khalilabad'),
(206, 'Delhi (DL)', 'East Delhi', 'ED', 'Preet Vihar'),
(207, 'Bihar (BR)', 'Buxar', 'BU', 'Buxar'),
(208, 'Madhya Pradesh (MP)', 'Bhind', 'BD', 'Bhind'),
(209, 'Gujarat (GJ)', 'Valsad', 'VL', 'Valsad'),
(210, 'Madhya Pradesh (MP)', 'Balaghat', 'BL', 'Balaghat'),
(211, 'Uttar Pradesh (UP)', 'Azamgarh', 'AZ', 'Azamgarh'),
(212, 'Karnataka (KA)', 'Bidar', 'BD', 'Bidar'),
(213, 'West Bengal (WB)', 'Alipurduar', 'AD', 'Alipurduar'),
(214, 'Uttarakhand (UK)', 'Dehradun', 'DD', 'Dehradun'),
(215, 'Odisha (OD)', 'Puri', 'PU', 'Puri'),
(216, 'Assam (AS)', 'Barpeta', 'BA', 'Barpeta'),
(217, 'Bihar (BR)', 'Kishanganj', 'KI', 'Kishanganj'),
(218, 'Uttar Pradesh (UP)', 'Gautam Buddh Nagar', 'GB', 'Noida'),
(219, 'West Bengal (WB)', 'Dakshin Dinajpur', 'DD', 'Balurghat'),
(220, 'Uttar Pradesh (UP)', 'Jalaun', 'JL', 'Orai'),
(221, 'Karnataka (KA)', 'Chitradurga', 'CT', 'Chitradurga'),
(222, 'Karnataka (KA)', 'Bangalore Urban', 'BN', 'Bangalore'),
(223, 'Uttar Pradesh (UP)', 'Lucknow', 'LU', 'Lucknow'),
(224, 'Maharashtra (MH)', 'Osmanabad', 'OS', 'Osmanabad'),
(225, 'Uttar Pradesh (UP)', 'Kannauj', 'KJ', 'Kannauj'),
(226, 'Bihar (BR)', 'Khagaria', 'KH', 'Khagaria'),
(227, 'Punjab (PB)', 'Sangrur', 'SA', 'Sangrur'),
(228, 'Odisha (OD)', 'Balangir', 'BL', 'Balangir'),
(229, 'Uttarakhand (UK)', 'Udham Singh Nagar', 'US', 'Rudrapur'),
(230, 'Maharashtra (MH)', 'Nandurbar', 'NB', 'Nandurbar'),
(231, 'Rajasthan (RJ)', 'Dausa', 'DA', 'Dausa'),
(232, 'Haryana (HR)', 'Bhiwani', 'BH', 'Bhiwani'),
(233, 'Bihar (BR)', 'Kaimur', 'KM', 'Bhabua'),
(234, 'Uttar Pradesh (UP)', 'Kanpur Nagar', 'KN', 'Kanpur'),
(235, 'Chhattisgarh (CG)', 'Janjgir-Champa', 'JC', 'Naila Janjgir'),
(236, 'Tamil Nadu (TN)', 'Nagapattinam', 'NG', 'Nagapattinam'),
(237, 'Maharashtra (MH)', 'Ratnagiri', 'RT', 'Ratnagiri'),
(238, 'Karnataka (KA)', 'Haveri district', 'HV', 'Haveri'),
(239, 'Uttar Pradesh (UP)', 'Kaushambi', 'KS', 'Manjhanpur'),
(240, 'Punjab (PB)', 'Hoshiarpur', 'HO', 'Hoshiarpur'),
(241, 'Uttar Pradesh (UP)', 'Etawah', 'EW', 'Etawah'),
(242, 'Madhya Pradesh (MP)', 'Betul', 'BE', 'Betul'),
(243, 'Odisha (OD)', 'Kalahandi', 'KL', 'Bhawanipatna'),
(244, 'Uttar Pradesh (UP)', 'Hathras (Mahamaya Nagar)', 'HT', 'Hathras'),
(245, 'Maharashtra (MH)', 'Ahmednagar', 'AH', 'Ahmednagar'),
(246, 'Madhya Pradesh (MP)', 'Dewas', 'DE', 'Dewas'),
(247, 'Uttar Pradesh (UP)', 'Sant Ravidas Nagar', 'SR', 'Gyanpur'),
(248, 'Gujarat (GJ)', 'Bharuch', 'BR', 'Bharuch'),
(249, 'Madhya Pradesh (MP)', 'Rajgarh', 'RG', 'Rajgarh'),
(250, 'Rajasthan (RJ)', 'Chittorgarh', 'CT', 'Chittorgarh'),
(251, 'Karnataka (KA)', 'Kolar', 'KL', 'Kolar'),
(252, 'Chhattisgarh (CG)', 'Rajnandgaon', 'RN', 'Rajnandgaon'),
(253, 'Jammu and Kashmir (JK)', 'Jammu', 'JA', 'Jammu'),
(254, 'Assam (AS)', 'Kamrup', 'KR', 'Goroimari'),
(255, 'Haryana (HR)', 'Gurgaon', 'GU', 'Gurgaon'),
(256, 'Andhra Pradesh (AP)', 'Krishna', 'KR', 'Machilipatnam'),
(257, 'Gujarat (GJ)', 'Amreli district', 'AM', 'Amreli'),
(258, 'Madhya Pradesh (MP)', 'Shajapur', 'SJ', 'Shajapur'),
(259, 'Himachal Pradesh (HP)', 'Kangra', 'KA', 'Dharamshala'),
(260, 'Odisha (OD)', 'Bhadrak', 'BH', 'Bhadrak'),
(261, 'Haryana (HR)', 'Karnal', 'KR', 'Karnal'),
(262, 'Tamil Nadu (TN)', 'Dharmapuri', 'DH', 'Dharmapuri'),
(263, 'Jharkhand (JH)', 'West Singhbhum', 'WS', 'Chaibasa'),
(264, 'Chhattisgarh (CG)', 'Raigarh', 'RG', 'Raigarh'),
(265, 'Jharkhand (JH)', 'Deoghar', 'DE', 'Deoghar'),
(266, 'Haryana (HR)', 'Sonipat', 'SNP', 'Sonipat'),
(267, 'West Bengal (WB)', 'Kolkata', 'KO', 'Kolkata'),
(268, 'Odisha (OD)', 'Bargarh (Baragarh)', 'BR', 'Bargarh'),
(269, 'Rajasthan (RJ)', 'Karauli', 'KA', 'Karauli'),
(270, 'Madhya Pradesh (MP)', 'Vidisha', 'VI', 'Vidisha'),
(271, 'Madhya Pradesh (MP)', 'Ratlam', 'RL', 'Ratlam'),
(272, 'Uttar Pradesh (UP)', 'Hapur (Panchsheel Nagar)', 'PN', 'Hapur'),
(273, 'Madhya Pradesh (MP)', 'Tikamgarh', 'TI', 'Tikamgarh'),
(274, 'Odisha (OD)', 'Kendrapara', 'KP', 'Kendrapara'),
(275, 'Uttar Pradesh (UP)', 'Kanshi Ram Nagar', 'KR', 'Kasganj'),
(276, 'Rajasthan (RJ)', 'Tonk', 'TO', 'Tonk'),
(277, 'Chhattisgarh (CG)', 'Bastar', 'BA', 'Jagdalpur'),
(278, 'Uttar Pradesh (UP)', 'Jaunpur district', 'JU', 'Jaunpur'),
(279, 'Rajasthan (RJ)', 'Jhalawar', 'JW', 'Jhalawar'),
(280, 'Karnataka (KA)', 'Koppal', 'KP', 'Koppal'),
(281, 'Rajasthan (RJ)', 'Dungapur', 'DU', 'Dungarpur'),
(282, 'Punjab (PB)', 'Bathinda', 'BA', 'Bathinda'),
(283, 'Gujarat (GJ)', 'Gandhinagar', 'GA', 'Gandhinagar'),
(284, 'Madhya Pradesh (MP)', 'Barwani', 'BR', 'Barwani'),
(285, 'Madhya Pradesh (MP)', 'Seoni', 'SO', 'Seoni'),
(286, 'Odisha (OD)', 'Koraput', 'KO', 'Koraput'),
(287, 'Uttar Pradesh (UP)', 'Auraiya', 'AU', 'Auraiya'),
(288, 'Bihar (BR)', 'Munger', 'MG', 'Munger'),
(289, 'Bihar (BR)', 'Madhubani', 'MB', 'Madhubani'),
(290, 'Karnataka (KA)', 'Uttara Kannada', 'UK', 'Karwar'),
(291, 'Gujarat (GJ)', 'Patan', 'PA', 'Patan'),
(292, 'Tamil Nadu (TN)', 'Sivaganga', 'SI', 'Sivaganga'),
(293, 'Madhya Pradesh (MP)', 'Mandsaur', 'MS', 'Mandsaur'),
(294, 'Rajasthan (RJ)', 'Sawai Madhopur', 'SM', 'Sawai Madhopur'),
(295, 'Tamil Nadu (TN)', 'Ramanathapuram', 'RA', 'Ramanathapuram'),
(296, 'Haryana (HR)', 'Jind', 'JI', 'Jind'),
(297, 'Madhya Pradesh (MP)', 'Raisen', 'RS', 'Raisen'),
(298, 'Gujarat (GJ)', 'Navsari', 'NV', 'Navsari'),
(299, 'Assam (AS)', 'Dibrugarh', 'DI', 'Dibrugarh'),
(300, 'Uttar Pradesh (UP)', 'Sitapur', 'SI', 'Sitapur'),
(301, 'Jharkhand (JH)', 'Garhwa', 'GA', 'Garhwa'),
(302, 'Maharashtra (MH)', 'Gondia', 'GO', 'Gondia'),
(303, 'Jharkhand (JH)', 'Dumka', 'DU', 'Dumka'),
(304, 'Assam (AS)', 'Tinsukia', 'TI', 'Tinsukia'),
(305, 'Jharkhand (JH)', 'Godda', 'GO', 'Godda'),
(306, 'Madhya Pradesh (MP)', 'Sehore', 'SR', 'Sehore'),
(307, 'Madhya Pradesh (MP)', 'Khandwa (East Nimar)', 'EN', 'Khandwa'),
(308, 'Kerala (KL)', 'Kasaragod', 'KS', 'Kasaragod'),
(309, 'Uttar Pradesh (UP)', 'Bagpat', 'BG', 'Baghpat'),
(310, 'Maharashtra (MH)', 'Wardha', 'WR', 'Wardha'),
(311, 'Uttar Pradesh (UP)', 'Bareilly', 'BR', 'Bareilly'),
(312, 'Haryana (HR)', 'Sirsa', 'SI', 'Sirsa'),
(313, 'Madhya Pradesh (MP)', 'Katni', 'KA', 'Katni'),
(314, 'Odisha (OD)', 'Angul', 'AN', 'Angul'),
(315, 'Jammu and Kashmir (JK)', 'Srinagar', 'SR', 'Srinagar'),
(316, 'Tamil Nadu (TN)', 'Tiruvarur', 'TR', 'Tiruvarur'),
(317, 'Madhya Pradesh (MP)', 'Damoh', 'DM', 'Damoh'),
(318, 'Assam (AS)', 'Kamrup Metropolitan', 'KM', 'Guwahati'),
(319, 'Karnataka (KA)', 'Chikkaballapur', 'CK', 'Chikkaballapur'),
(320, 'Tamil Nadu (TN)', 'Theni', 'TH', 'Theni'),
(321, 'Madhya Pradesh (MP)', 'Hoshangabad', 'HO', 'Hoshangabad'),
(322, 'Uttar Pradesh (UP)', 'Gorakhpur', 'GR', 'Gorakhpur'),
(323, 'Madhya Pradesh (MP)', 'Guna', 'GU', 'Guna'),
(324, 'Rajasthan (RJ)', 'Baran', 'BR', 'Baran'),
(325, 'Odisha (OD)', 'Nabarangpur', 'NB', 'Nabarangpur'),
(326, 'Uttar Pradesh (UP)', 'Lalitpur', 'LA', 'Lalitpur'),
(327, 'Gujarat (GJ)', 'Gir Somnath', '', 'Veraval'),
(328, 'Assam (AS)', 'Karimganj', 'KR', 'Karimganj'),
(329, 'Haryana (HR)', 'Yamuna Nagar', 'YN', 'Yamuna Nagar'),
(330, 'Rajasthan (RJ)', 'Dholpur', 'DH', 'Dholpur'),
(331, 'Chhattisgarh (CG)', 'Korba', 'KB', 'Korba'),
(332, 'Haryana (HR)', 'Panipat', 'PP', 'Panipat'),
(333, 'Maharashtra (MH)', 'Pune', 'PU', 'Pune'),
(334, 'West Bengal (WB)', 'Purba Medinipur', 'PR', 'Tamluk'),
(335, 'Maharashtra (MH)', 'Bhandara', 'BH', 'Bhandara'),
(336, 'Maharashtra (MH)', 'Washim', 'WS', 'Washim'),
(337, 'Kerala (KL)', 'Pathanamthitta', 'PT', 'Pathanamthitta'),
(338, 'Odisha (OD)', 'Dhenkanal', 'DH', 'Dhenkanal'),
(339, 'Maharashtra (MH)', 'Hingoli', 'HI', 'Hingoli'),
(340, 'Madhya Pradesh (MP)', 'Singrauli', 'SN', 'Waidhan'),
(341, 'Karnataka (KA)', 'Udupi', 'UD', 'Udupi'),
(342, 'Karnataka (KA)', 'Yadgir', 'YG', 'Yadgir'),
(343, 'Rajasthan (RJ)', 'Rajsamand', 'RA', 'Rajsamand'),
(344, 'Assam (AS)', 'Sivasagar', 'SI', 'Sibsagar'),
(345, 'Uttar Pradesh (UP)', 'Agra', 'AG', 'Agra'),
(346, 'Jharkhand (JH)', 'Sahibganj', 'SA', 'Sahebganj'),
(347, 'Karnataka (KA)', 'Chikkamagaluru', 'CK', 'Chikmagalur'),
(348, 'Haryana (HR)', 'Ambala', 'AM', 'Ambala'),
(349, 'Odisha (OD)', 'Jagatsinghpur', 'JS', 'Jagatsinghpur'),
(350, 'Madhya Pradesh (MP)', 'Sidhi', 'SI', 'Sidhi'),
(351, 'Bihar (BR)', 'Jehanabad', 'JE', 'Jehanabad'),
(352, 'Punjab (PB)', 'Tarn Taran', 'TT', 'Tarn Taran Sahib'),
(353, 'Uttar Pradesh (UP)', 'Shravasti', 'SV', 'Shravasti'),
(354, 'Rajasthan (RJ)', 'Bundi', 'BU', 'Bundi'),
(355, 'Kerala (KL)', 'Idukki', 'ID', 'Painavu'),
(356, 'Bihar (BR)', 'Gaya', 'GA', 'Gaya'),
(357, 'Uttar Pradesh (UP)', 'Hamirpur', 'HM', 'Hamirpur'),
(358, 'Madhya Pradesh (MP)', 'Narsinghpur', 'NA', 'Narsinghpur'),
(359, 'Assam (AS)', 'Jorhat', 'JO', 'Jorhat'),
(360, 'Haryana (HR)', 'Mewat', 'MW', 'Nuh'),
(361, 'Karnataka (KA)', 'Ramanagara', 'RM', 'Ramanagara'),
(362, 'Tamil Nadu (TN)', 'Karur', 'KA', 'Karur'),
(363, 'Haryana (HR)', 'Kaithal', 'KT', 'Kaithal'),
(364, 'Gujarat (GJ)', 'Chhota Udaipur', '', 'Chhota Udaipur'),
(365, 'Maharashtra (MH)', 'Gadchiroli', 'GA', 'Gadchiroli'),
(366, 'Jammu and Kashmir (JK)', 'Anantnag', 'AN', 'Anantnag'),
(367, 'Maharashtra (MH)', 'Solapur', 'SO', 'Solapur'),
(368, 'Karnataka (KA)', 'Gadag', 'GA', 'Gadag-Betageri'),
(369, 'Madhya Pradesh (MP)', 'Shahdol', 'SH', 'Shahdol'),
(370, 'Jharkhand (JH)', 'Seraikela Kharsawan', 'SK', 'Seraikela'),
(371, 'Haryana (HR)', 'Rohtak', 'RO', 'Rohtak'),
(372, 'Assam (AS)', 'Golaghat', 'GG', 'Golaghat'),
(373, 'Chandigarh (CH)', 'Chandigarh', 'CH', 'Chandigarh'),
(374, 'Madhya Pradesh (MP)', 'Mandla', 'ML', 'Mandla'),
(375, 'Gujarat (GJ)', 'Aravalli', 'AR', 'Modasa'),
(376, 'Odisha (OD)', 'Sambalpur', 'SA', 'Sambalpur'),
(377, 'Jharkhand (JH)', 'Chatra', 'CH', 'Chatra'),
(378, 'Andhra Pradesh (AP)', 'Visakhapatnam', 'VS', 'Visakhapatnam'),
(379, 'Assam (AS)', 'Lakhimpur', 'LA', 'North Lakhimpur'),
(380, 'Haryana (HR)', 'Palwal', 'PW', 'Palwal'),
(381, 'Rajasthan (RJ)', 'Sirohi', 'SR', 'Sirohi'),
(382, 'Chhattisgarh (CG)', 'Mahasamund', 'MA', 'Mahasamund'),
(383, 'Jharkhand (JH)', 'Gumla', 'GU', 'Gumla'),
(384, 'Madhya Pradesh (MP)', 'Jhabua', 'JH', 'Jhabua'),
(385, 'Karnataka (KA)', 'Chamarajnagar', 'CJ', 'Chamarajanagar'),
(386, 'Madhya Pradesh (MP)', 'Panna', 'PA', 'Panna'),
(387, 'Jammu and Kashmir (JK)', 'Baramulla', 'BR', 'Baramulla'),
(388, 'Assam (AS)', 'Goalpara', 'GP', 'Goalpara'),
(389, 'Bihar (BR)', 'Samastipur', 'SM', 'Samastipur'),
(390, 'Bihar (BR)', 'Lakhisarai', 'LA', 'Lakhisarai'),
(391, 'Himachal Pradesh (HP)', 'Mandi', 'MA', 'Mandi'),
(392, 'Gujarat (GJ)', 'Mahisagar', 'MH', 'Lunavada'),
(393, 'Punjab (PB)', 'Moga', 'MO', 'Moga'),
(394, 'Uttar Pradesh (UP)', 'Chitrakoot', 'CT', 'Chitrakoot'),
(395, 'Karnataka (KA)', 'Bangalore Rural', 'BR', 'Bangalore'),
(396, 'Punjab (PB)', 'Sahibzada Ajit Singh Nagar', 'SAS', 'Ajitgarh'),
(397, 'Assam (AS)', 'Karbi Anglong', 'KA', 'Diphu'),
(398, 'Haryana (HR)', 'Kurukshetra', 'KU', 'Kurukshetra'),
(399, 'Odisha (OD)', 'Nayagarh', 'NY', 'Nayagarh'),
(400, 'Maharashtra (MH)', 'Jalgaon', 'JG', 'Jalgaon'),
(401, 'Odisha (OD)', 'Rayagada', 'RA', 'Rayagada'),
(402, 'Gujarat (GJ)', 'Morbi', '', 'Morbi'),
(403, 'Assam (AS)', 'Morigaon', 'MA', 'Marigaon'),
(404, 'Haryana (HR)', 'Jhajjar', 'JH', 'Jhajjar'),
(405, 'Uttarakhand (UK)', 'Nainital', 'NA', 'Nainital'),
(406, 'Assam (AS)', 'Baksa', 'BK', 'Mushalpur'),
(407, 'Jharkhand (JH)', 'Ramgarh', 'RM', 'Ramgarh'),
(408, 'Puducherry (PY)', 'Pondicherry', 'PO', 'Pondicherry'),
(409, 'Haryana (HR)', 'Fatehabad', 'FT', 'Fatehabad'),
(410, 'Haryana (HR)', 'Mahendragarh', 'MA', 'Narnaul'),
(411, 'Andhra Pradesh (AP)', 'Chittoor', 'CH', 'Chittoor'),
(412, 'Tripura (TR)', 'West Tripura', 'WT', 'Agartala'),
(413, 'Assam (AS)', 'Darrang', 'DA', 'Mangaldoi'),
(414, 'Punjab (PB)', 'Sri Muktsar Sahib', 'MU', 'Sri Muktsar Sahib'),
(415, 'Jharkhand (JH)', 'Pakur', 'PK', 'Pakur'),
(416, 'Haryana (HR)', 'Rewari', 'RE', 'Rewari'),
(417, 'Assam (AS)', 'Kokrajhar', 'KK', 'Kokrajhar'),
(418, 'Delhi (DL)', 'North Delhi', 'NO', 'Sadar Bazaar'),
(419, 'Uttar Pradesh (UP)', 'Mahoba', 'MH', 'Mahoba'),
(420, 'Jammu and Kashmir (JK)', 'Kupwara', 'KU', 'Kupwara'),
(421, 'Rajasthan (RJ)', 'Pratapgarh', 'PG', 'Pratapgarh'),
(422, 'Uttar Pradesh (UP)', 'Muzaffarnagar', 'MU', 'Muzaffarnagar'),
(423, 'Chhattisgarh (CG)', 'Jashpur', 'JA', 'Jashpur Nagar'),
(424, 'Maharashtra (MH)', 'Sindhudurg', 'SI', 'Oros'),
(425, 'Madhya Pradesh (MP)', 'Ashok Nagar', 'AS', 'Ashok Nagar'),
(426, 'Assam (AS)', 'Udalguri', 'UD', 'Udalguri'),
(427, 'Madhya Pradesh (MP)', 'Neemuch', 'NE', 'Neemuch'),
(428, 'Meghalaya (ML)', 'East Khasi Hills', 'EK', 'Shillong'),
(429, 'Goa (GA)', 'North Goa', 'NG', 'Panaji'),
(430, 'Punjab (PB)', 'Kapurthala', 'KA', 'Kapurthala'),
(431, 'Kerala (KL)', 'Wayanad', 'WA', 'Kalpetta'),
(432, 'Himachal Pradesh (HP)', 'Shimla', 'SH', 'Shimla'),
(433, 'Kerala (KL)', 'Malappuram', 'MA', 'Malappuram'),
(434, 'Gujarat (GJ)', 'Tapi', 'TA', 'Vyara'),
(435, 'Chhattisgarh (CG)', 'Dhamtari', 'DH', 'Dhamtari'),
(436, 'Jharkhand (JH)', 'Jamtara', 'JA', 'Jamtara'),
(437, 'Madhya Pradesh (MP)', 'Datia', 'DT', 'Datia'),
(438, 'Assam (AS)', 'Nalbari', 'NL', 'Nalbari'),
(439, 'Punjab (PB)', 'Mansa', 'MA', 'Mansa'),
(440, 'Madhya Pradesh (MP)', 'Burhanpur', 'BU', 'Burhanpur'),
(441, 'Gujarat (GJ)', 'Devbhoomi Dwarka', '', 'Khambhalia'),
(442, 'Tamil Nadu (TN)', 'Ariyalur', 'AY', 'Ariyalur'),
(443, 'Madhya Pradesh (MP)', 'Anuppur', 'AP', 'Anuppur'),
(444, 'Maharashtra (MH)', 'Mumbai suburban', 'MU', 'Bandra (East)'),
(445, 'Uttar Pradesh (UP)', 'Hardoi', 'HR', 'Hardoi'),
(446, 'Chhattisgarh (CG)', 'Kanker', 'KK', 'Kanker'),
(447, 'Jammu and Kashmir (JK)', 'Badgam', 'BD', 'Badgam'),
(448, 'Tamil Nadu (TN)', 'Nilgiris', 'NI', 'Udagamandalam (Ootacamund/Ooty)'),
(449, 'Assam (AS)', 'Bongaigaon', 'BO', 'Bongaigaon'),
(450, 'Odisha (OD)', 'Kandhamal', 'KN', 'Phulbani'),
(451, 'Madhya Pradesh (MP)', 'Alirajpur', 'AL', 'Alirajpur'),
(452, 'Jharkhand (JH)', 'Latehar', 'LA', 'Latehar'),
(453, 'Jharkhand (JH)', 'Koderma', 'KO', 'Koderma'),
(454, 'Madhya Pradesh (MP)', 'Dindori', 'DI', 'Dindori'),
(455, 'Bihar (BR)', 'Arwal', 'AR', 'Arwal'),
(456, 'Andhra Pradesh (AP)', 'Anantapur', 'AN', 'Anantapur'),
(457, 'Assam (AS)', 'Dhemaji', 'DM', 'Dhemaji'),
(458, 'Madhya Pradesh (MP)', 'Sheopur', 'SP', 'Sheopur'),
(459, 'Uttarakhand (UK)', 'Pauri Garhwal', 'PG', 'Pauri'),
(460, 'Punjab (PB)', 'Rupnagar', 'RU', 'Rupnagar'),
(461, 'Rajasthan (RJ)', 'Jaisalmer', 'JS', 'Jaisalmer'),
(462, 'Chhattisgarh (CG)', 'Surajpur', 'SJ', 'Surajpur'),
(463, 'Assam (AS)', 'Hailakandi', 'HA', 'Hailakandi'),
(464, 'Chhattisgarh (CG)', 'Koriya', 'KJ', 'Baikunthpur'),
(465, 'Bihar (BR)', 'Sheohar', 'SO', 'Sheohar'),
(466, 'Gujarat (GJ)', 'Botad', '', 'Botad'),
(467, 'Chhattisgarh (CG)', 'Raipur', 'RP', 'Raipur'),
(468, 'Odisha (OD)', 'Subarnapur (Sonepur)', 'SO', 'Subarnapur'),
(469, 'Madhya Pradesh (MP)', 'Umaria', 'UM', 'Umaria'),
(470, 'Meghalaya (ML)', 'West Garo Hills', 'WG', 'Tura'),
(471, 'Goa (GA)', 'South Goa', 'SG', 'Margao'),
(472, 'Bihar (BR)', 'Sheikhpura', 'SP', 'Sheikhpura'),
(473, 'Uttarakhand (UK)', 'Almora', 'AL', 'Almora'),
(474, 'Jammu and Kashmir (JK)', 'Rajouri', 'RA', 'Rajouri'),
(475, 'Punjab (PB)', 'Faridkot', 'FR', 'Faridkot'),
(476, 'Uttarakhand (UK)', 'Tehri Garhwal', 'TG', 'New Tehri'),
(477, 'Jammu and Kashmir (JK)', 'Kathua', 'KT', 'Kathua'),
(478, 'Andhra Pradesh (AP)', 'Kurnool', 'KU', 'Kurnool'),
(479, 'Punjab (PB)', 'Shahid Bhagat Singh Nagar', 'PB', 'Nawanshahr'),
(480, 'Odisha (OD)', 'Malkangiri', 'ML', 'Malkangiri'),
(481, 'Odisha (OD)', 'Nuapada', 'NU', 'Nuapada'),
(482, 'Punjab (PB)', 'Fatehgarh Sahib', 'FT', 'Fatehgarh Sahib'),
(483, 'Jharkhand (JH)', 'Simdega', 'SI', 'Simdega'),
(484, 'Punjab (PB)', 'Barnala', 'BNL', 'Barnala'),
(485, 'Gujarat (GJ)', 'Narmada', 'NR', 'Rajpipla'),
(486, 'Gujarat (GJ)', 'Porbandar', 'PO', 'Porbandar'),
(487, 'Chhattisgarh (CG)', 'Kabirdham (formerly Kawardha)', 'KW', 'Kawardha'),
(488, 'Odisha (OD)', 'Jharsuguda', 'JH', 'Jharsuguda'),
(489, 'Telangana (TS)', 'Mahbubnagar', 'MA', 'Mahbubnagar'),
(490, 'Delhi (DL)', 'Central Delhi', 'CD', 'Daryaganj'),
(491, 'Himachal Pradesh (HP)', 'Solan', 'SO', 'Solan'),
(492, 'Odisha (OD)', 'Gajapati', 'GP', 'Paralakhemundi'),
(493, 'Madhya Pradesh (MP)', 'Harda', 'HA', 'Harda'),
(494, 'Jammu and Kashmir (JK)', 'Pulwama', 'PU', 'Pulwama'),
(495, 'Tamil Nadu (TN)', 'Perambalur', 'PE', 'Perambalur'),
(496, 'Haryana (HR)', 'Panchkula', 'PK', 'Panchkula'),
(497, 'Jammu and Kashmir (JK)', 'Udhampur', 'UD', 'Udhampur'),
(498, 'Karnataka (KA)', 'Kodagu', 'KD', 'Madikeri'),
(499, 'Chhattisgarh (CG)', 'Dantewada', 'DA', 'Dantewada'),
(500, 'Uttar Pradesh (UP)', 'Lakhimpur Kheri', 'LK', 'Lakhimpur'),
(501, 'Jharkhand (JH)', 'Khunti', 'KH', 'Khunti'),
(502, 'Himachal Pradesh (HP)', 'Sirmaur', 'SI', 'Nahan'),
(503, 'Himachal Pradesh (HP)', 'Una', 'UNA', 'Una'),
(504, 'Himachal Pradesh (HP)', 'Chamba', 'CH', 'Chamba'),
(505, 'Manipur (MN)', 'Imphal West', 'WI', 'Lamphelpat'),
(506, 'Uttarakhand (UK)', 'Pithoragarh', 'PI', 'Pithoragarh'),
(507, 'Tripura (TR)', 'Sepahijala', 'SP', 'Bishramganj'),
(508, 'Assam (AS)', 'Chirang', 'CH', 'Kajalgaon'),
(509, 'Jammu and Kashmir (JK)', 'Poonch', 'PO', 'Poonch'),
(510, 'Jharkhand (JH)', 'Lohardaga', 'LO', 'Lohardaga'),
(511, 'Telangana (TS)', 'Hyderabad', 'HY', 'Hyderabad'),
(512, 'Himachal Pradesh (HP)', 'Hamirpur', 'HA', 'Hamirpur'),
(513, 'Manipur (MN)', 'Imphal East', 'EI', 'Porompat'),
(514, 'Odisha (OD)', 'Boudh (Bauda)', 'BD', 'Boudh'),
(515, 'Himachal Pradesh (HP)', 'Kullu', 'KU', 'Kullu'),
(516, 'Tripura (TR)', 'Gomati', 'GM', 'Udaipur, Tripura'),
(517, 'Tripura (TR)', 'South Tripura', 'ST', 'Belonia'),
(518, 'Jammu and Kashmir (JK)', 'Kulgam', 'KG', 'Kulgam'),
(519, 'Chhattisgarh (CG)', 'Surguja', 'SJ', 'Surguja'),
(520, 'Manipur (MN)', 'Thoubal', 'TH', 'Thoubal'),
(521, 'Tripura (TR)', 'North Tripura', 'NT', 'Dharmanagar'),
(522, 'West Bengal (WB)', 'Maldah', 'MA', 'English Bazar'),
(523, 'Mizoram (MZ)', 'Tuensang', 'TU', 'Tuensang'),
(524, 'Jammu and Kashmir (JK)', 'Doda', 'DO', 'Doda'),
(525, 'Mizoram (MZ)', 'Aizawl', 'AI', 'Aizawl'),
(526, 'Uttarakhand (UK)', 'Chamoli', 'CL', 'Gopeshwar'),
(527, 'Meghalaya (ML)', 'West Khasi Hills', 'WK', 'Nongstoin'),
(528, 'Jammu and Kashmir (JK)', 'Bandipora', 'BPR', 'Bandipore'),
(529, 'Himachal Pradesh (HP)', 'Bilaspur', 'BI', 'Bilaspur'),
(530, 'Mizoram (MZ)', 'Dimapur', 'DI', 'Dimapur'),
(531, 'Tripura (TR)', 'Dhalai', 'DH', 'Ambassa'),
(532, 'Manipur (MN)', 'Senapati', 'SE', 'Senapati'),
(533, 'Tamil Nadu (TN)', 'Madurai', 'MA', 'Madurai'),
(534, 'Dadra and Nagar Haveli (DN)', 'Dadra and Nagar Haveli', 'DN', 'Silvassa'),
(535, 'Uttarakhand (UK)', 'Uttarkashi', 'UT', 'Uttarkashi'),
(536, 'Tripura (TR)', 'Khowai', 'KH', 'Khowai'),
(537, 'Jammu and Kashmir (JK)', 'Samba', 'SB', 'Samba'),
(538, 'Meghalaya (ML)', 'East Garo Hills', 'EG', 'Williamnagar'),
(539, 'Jammu and Kashmir (JK)', 'Reasi', 'RS', 'Reasi'),
(540, 'Odisha (OD)', 'Debagarh (Deogarh)', 'DE', 'Debagarh'),
(541, 'Jammu and Kashmir (JK)', 'Ganderbal', 'GB', 'Ganderbal'),
(542, 'Jammu and Kashmir (JK)', 'Ramban', 'RB', 'Ramban'),
(543, 'Sikkim (SK)', 'East Sikkim', 'ES', 'Gangtok'),
(544, 'Tamil Nadu (TN)', 'Kanchipuram', 'KC', 'Kanchipuram'),
(545, 'Tripura (TR)', 'Unokoti', 'UK', 'Kailashahar'),
(546, 'Manipur (MN)', 'Churachandpur', 'CC', 'Churachandpur'),
(547, 'Meghalaya (ML)', 'West Jaintia Hills', 'WG', 'Jowai'),
(548, 'Mizoram (MZ)', 'Kohima', 'KO', 'Kohima'),
(549, 'Jammu and Kashmir (JK)', 'Shopian', 'SH', 'Shupiyan'),
(550, 'Uttarakhand (UK)', 'Bageshwar', 'BA', 'Bageshwar'),
(551, 'Mizoram (MZ)', 'Mon', 'MN', 'Mon'),
(552, 'Uttarakhand (UK)', 'Champawat', 'CP', 'Champawat'),
(553, 'Meghalaya (ML)', 'Ri Bhoi', 'RB', 'Nongpoh'),
(554, 'Chhattisgarh (CG)', 'Bijapur', 'BJ', 'Bijapur'),
(555, 'West Bengal (WB)', 'South 24 Parganas', 'PS', 'Alipore'),
(556, 'Bihar (BR)', 'Saran', 'SR', 'Chhapra'),
(557, 'Chhattisgarh (CG)', 'Sukma', 'SK', 'Sukma'),
(558, 'Manipur (MN)', 'Bishnupur', 'BI', 'Bishnupur'),
(559, 'Andaman and Nicobar (AN)', 'South Andaman', 'SA', 'Port Blair'),
(560, 'Uttarakhand (UK)', 'Rudraprayag', 'RP', 'Rudraprayag'),
(561, 'Jammu and Kashmir (JK)', 'Kishtwar', 'KW', 'Kishtwar'),
(562, 'Gujarat (GJ)', 'Dang', 'DG', 'Ahwa'),
(563, 'Assam (AS)', 'Dima Hasao', 'NC', 'Haflong'),
(564, 'Puducherry (PY)', 'Karaikal', 'KA', 'Karaikal'),
(565, 'Mizoram (MZ)', 'Mokokchung', 'MK', 'Mokokchung'),
(566, 'Daman and Diu (DD)', 'Daman', 'DA', 'Daman'),
(567, 'Bihar (BR)', 'West Champaran', 'WC', 'Bettiah'),
(568, 'Manipur (MN)', 'Ukhrul', 'UK', 'Ukhrul'),
(569, 'Arunachal Pradesh (AR)', 'Papum Pare', 'PA', 'Yupia'),
(570, 'Mizoram (MZ)', 'Wokha', 'WO', 'Wokha'),
(571, 'Mizoram (MZ)', 'Peren', 'PE', 'Peren'),
(572, 'Mizoram (MZ)', 'Phek', 'PH', 'Phek'),
(573, 'Mizoram (MZ)', 'Lunglei', 'LU', 'Lunglei'),
(574, 'Arunachal Pradesh (AR)', 'Changlang', 'CH', 'Changlang'),
(575, 'Jammu and Kashmir (JK)', 'Leh', 'LE', 'Leh'),
(576, 'Sikkim (SK)', 'South Sikkim', 'SS', 'Namchi'),
(577, 'Arunachal Pradesh (AR)', 'Lohit', 'EL', 'Tezu'),
(578, 'Andhra Pradesh (AP)', 'West Godavari', 'WG', 'Eluru'),
(579, 'Manipur (MN)', 'Chandel', 'CD', 'Chandel'),
(580, 'Jammu and Kashmir (JK)', 'Kargil', 'KR', 'Kargil'),
(581, 'Meghalaya (ML)', 'South Garo Hills', 'SG', 'Baghmara'),
(582, 'Mizoram (MZ)', 'Zunheboto', 'ZU', 'Zunheboto'),
(583, 'Chhattisgarh (CG)', 'Narayanpur', 'NR', 'Narayanpur'),
(584, 'Manipur (MN)', 'Tamenglong', 'TA', 'Tamenglong'),
(585, 'Sikkim (SK)', 'West Sikkim', 'WS', 'Geyzing'),
(586, 'Delhi (DL)', 'New Delhi', 'ND', 'Connaught Place'),
(587, 'Mizoram (MZ)', 'Champhai', 'CH', 'Champhai'),
(588, 'Meghalaya (ML)', 'East Jaintia Hills', '', 'Khleihriat'),
(589, 'Tamil Nadu (TN)', 'Vellore', 'VE', 'Vellore'),
(590, 'Meghalaya (ML)', 'North Garo Hills', '', 'Resubelpara'),
(591, 'Mizoram (MZ)', 'Lawngtlai', 'LA', 'Lawngtlai'),
(592, 'Arunachal Pradesh (AR)', 'West Siang', 'WS', 'Along'),
(593, 'Arunachal Pradesh (AR)', 'Tirap', 'TI', 'Khonsa'),
(594, 'Meghalaya (ML)', 'South West Khasi Hills', '', 'Mawkyrwat'),
(595, 'Andaman and Nicobar (AN)', 'North and Middle Andaman', 'NA', 'Mayabunder'),
(596, 'Arunachal Pradesh (AR)', 'East Siang', 'ES', 'Pasighat'),
(597, 'Arunachal Pradesh (AR)', 'Kurung Kumey', 'KK', 'Koloriang'),
(598, 'Arunachal Pradesh (AR)', 'West Kameng', 'WK', 'Bomdila'),
(599, 'Mizoram (MZ)', 'Mamit', 'MA', 'Mamit'),
(600, 'Bihar (BR)', 'Darbhanga', 'DA', 'Darbhanga'),
(601, 'Himachal Pradesh (HP)', 'Kinnaur', 'KI', 'Reckong Peo'),
(602, 'Arunachal Pradesh (AR)', 'Upper Subansiri', 'UB', 'Daporijo'),
(603, 'Mizoram (MZ)', 'Kolasib', 'KO', 'Kolasib'),
(604, 'Arunachal Pradesh (AR)', 'Lower Subansiri', 'LB', 'Ziro'),
(605, 'Arunachal Pradesh (AR)', 'East Kameng', 'EK', 'Seppa'),
(606, 'Mizoram (MZ)', 'Kiphire', 'KI', 'Kiphire'),
(607, 'Mizoram (MZ)', 'Serchhip', 'SE', 'Serchhip'),
(608, 'Lakshadweep (LD)', 'Lakshadweep', 'LD', 'Kavaratti'),
(609, 'Mizoram (MZ)', 'Saiha', 'SA', 'Saiha'),
(610, 'Puducherry (PY)', 'Yanam', 'YA', 'Yanam'),
(611, 'Maharashtra (MH)', 'Kolhapur', 'KO', 'Kolhapur'),
(612, 'Arunachal Pradesh (AR)', 'Lower Dibang Valley', 'DV', 'Anini'),
(613, 'Daman and Diu (DD)', 'Diu', 'DI', 'Diu'),
(614, 'Mizoram (MZ)', 'Longleng', 'LO', 'Longleng'),
(615, 'Arunachal Pradesh (AR)', 'Tawang', 'TA', 'Tawang Town'),
(616, 'Sikkim (SK)', 'North Sikkim', 'NS', 'Mangan'),
(617, 'Puducherry (PY)', 'Mahe', 'MA', 'Mahé'),
(618, 'Andaman and Nicobar (AN)', 'Nicobar', 'NI', 'Car Nicobar'),
(619, 'Arunachal Pradesh (AR)', 'Upper Siang', 'US', 'Yingkiong'),
(620, 'Himachal Pradesh (HP)', 'Lahaul and Spiti', 'LS', 'Keylong'),
(621, 'Arunachal Pradesh (AR)', 'Anjaw', 'AJ', 'Hawai'),
(622, 'West Bengal (WB)', 'Jalpaiguri', 'JA', 'Jalpaiguri'),
(623, 'Arunachal Pradesh (AR)', 'Dibang Valley', 'UD', 'Anini'),
(624, 'Punjab (PB)', 'Fazilka', 'FA', 'Fazilka'),
(625, 'Uttar Pradesh (UP)', 'Shamli', 'SH', 'Shamli'),
(626, 'Chhattisgarh (CG)', 'Balrampur', '', 'Balrampur'),
(627, 'Chhattisgarh (CG)', 'Bemetara', '', 'Bemetara'),
(628, 'Maharashtra (MH)', 'Palghar', '-', 'Palghar'),
(629, 'Arunachal Pradesh (AR)', 'Longding', 'LD', 'Longding'),
(630, 'Chhattisgarh (CG)', 'Balod', '', 'Balod'),
(631, 'Chhattisgarh (CG)', 'Baloda Bazar', '', 'Baloda Bazar'),
(632, 'Chhattisgarh (CG)', 'Gariaband', '', 'Gariaband'),
(633, 'Telangana (TS)', 'Karimnagar', 'KA', 'Karimnagar'),
(634, 'Chhattisgarh (CG)', 'Kondagaon', '', 'Kondagaon'),
(635, 'Chhattisgarh (CG)', 'Mungeli', '', 'Mungeli'),
(636, 'Delhi (DL)', 'Shahdara', '', 'Shahdara'),
(637, 'Delhi (DL)', 'South East Delhi', '', 'Defence Colony'),
(638, 'Madhya Pradesh (MP)', 'Agar', 'AG', 'Agar'),
(639, 'Meghalaya (ML)', 'South West Garo Hills', '', 'Ampati'),
(640, 'Uttar Pradesh (UP)', 'Amethi (Chhatrapati Shahuji Maharaj Nagar)', 'CS', 'Gauriganj'),
(641, 'Uttar Pradesh (UP)', 'Sultanpur', 'SU', 'Sultanpur'),
(642, 'Tamil Nadu (TN)', 'Tiruvallur', 'TL', 'Tiruvallur'),
(643, 'West Bengal (WB)', 'Bardhaman', 'BR', 'Bardhaman'),
(644, 'Uttar Pradesh (UP)', 'Budaun', 'BD', 'Budaun'),
(645, 'Maharashtra (MH)', 'Aurangabad', 'AU', 'Aurangabad'),
(646, 'Rajasthan (RJ)', 'Jodhpur', 'JO', 'Jodhpur'),
(647, 'Uttar Pradesh (UP)', 'Bijnor', 'BI', 'Bijnor'),
(648, 'Uttar Pradesh (UP)', 'Varanasi', 'VA', 'Varanasi'),
(649, 'Uttar Pradesh (UP)', 'Aligarh', 'AL', 'Aligarh'),
(650, 'Rajasthan (RJ)', 'Alwar', 'AL', 'Alwar'),
(651, 'Delhi (DL)', 'North West Delhi', 'NW', 'Kanjhawala'),
(652, 'Gujarat (GJ)', 'Vadodara', 'VD', 'Vadodara'),
(653, 'Uttar Pradesh (UP)', 'Ghazipur', 'GP', 'Ghazipur'),
(654, 'Gujarat (GJ)', 'Ahmedabad', 'AH', 'Ahmedabad'),
(655, 'West Bengal (WB)', 'Bankura', 'BN', 'Bankura'),
(656, 'Uttar Pradesh (UP)', 'Kushinagar', 'KU', 'Padrauna'),
(657, 'Telangana (TS)', 'Warangal', 'WA', 'Warangal'),
(658, 'Odisha (OD)', 'Ganjam', 'GN', 'Chhatrapur'),
(659, 'West Bengal (WB)', 'Birbhum', 'BI', 'Suri'),
(660, 'Uttar Pradesh (UP)', 'Bulandshahr', 'BU', 'Bulandshahr'),
(661, 'Bihar (BR)', 'Vaishali', 'VA', 'Hajipur'),
(662, 'Punjab (PB)', 'Ludhiana', 'LU', 'Ludhiana'),
(663, 'Telangana (TS)', 'Nalgonda', 'NA', 'Nalgonda'),
(664, 'Tamil Nadu (TN)', 'Salem', 'SA', 'Salem'),
(665, 'West Bengal (WB)', 'Murshidabad', 'MSD', 'Baharampur'),
(666, 'Tamil Nadu (TN)', 'Coimbatore', 'CO', 'Coimbatore'),
(667, 'Uttar Pradesh (UP)', 'Saharanpur', 'SA', 'Saharanpur'),
(668, 'Tamil Nadu (TN)', 'Viluppuram', 'VL', 'Viluppuram'),
(669, 'Uttar Pradesh (UP)', 'Meerut', 'ME', 'Meerut'),
(670, 'Uttar Pradesh (UP)', 'Gonda', 'GN', 'Gonda'),
(671, 'Bihar (BR)', 'Sitamarhi', 'ST', 'Sitamarhi'),
(672, 'Uttar Pradesh (UP)', 'Raebareli', 'RB', 'Raebareli'),
(673, 'Andhra Pradesh (AP)', 'Prakasam', 'PR', 'Ongole'),
(674, 'Maharashtra (MH)', 'Nanded', 'ND', 'Nanded'),
(675, 'Chhattisgarh (CG)', 'Durg', 'DU', 'Durg'),
(676, 'Maharashtra (MH)', 'Thane', 'TH', 'Thane');
...
INSERT INTO `subscription` (`id`, `code`, `startdate`, `enddate`, `status`) VALUES
(1, '71dbb97c35e95d4a9cf958ea66bc2bd2[FMS2ub1]', 'cdf4444479462614f1b72a8753b7f812', '7ad28feeda5ea2a686d2e18394845906', 1);
...
CREATE TABLE `transaction` (
  ...
  `accno` varchar(255) NOT NULL COMMENT 'foreign key',
  `amount` decimal(11,2) NOT NULL,
  `datee` varchar(255) NOT NULL,
  `for_the_month` varchar(55) NOT NULL,
  `deposit_by` varchar(255) NOT NULL,
  `collected_by` varchar(255) NOT NULL,
  `doe` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `type` enum('R','L') NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  `approve` enum('Yes','No') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `transaction` (`trans_id`, `cid`, `accno`, `amount`, `datee`, `for_the_month`, `deposit_by`, `collected_by`, `doe`, `type`, `status`, `approve`) VALUES
(36, 4, '101', '200.00', '01-01-2018', '1', 'Sougata', 'Pankaj', '2018-02-02 17:30:07', 'R', 0, 'No'),
(37, 4, '101', '100.00', '01-01-2018', '1', 'Sougata', 'Pankaj', '2018-02-02 17:30:07', 'L', 0, 'No'),
(38, 4, '101', '200.00', '03-01-2018', '1', 'Sougata', 'Pankaj', '2018-02-02 17:30:07', 'R', 0, 'No'),
(39, 4, '101', '100.00', '03-01-2018', '1', 'Sougata', 'Pankaj', '2018-02-02 17:30:07', 'L', 0, 'No'),
(40, 4, '101', '200.00', '03-02-2018', '2', 'Sougata', 'Pankaj', '2018-02-02 17:30:07', 'R', 0, 'No'),
(41, 4, '101', '100.00', '03-02-2018', '2', 'Sougata', 'Pankaj', '2018-02-02 17:30:08', 'L', 0, 'No'),
(42, 4, '101', '200.00', '04-02-2018', '2', 'Sougata', 'Pankaj', '2018-02-02 17:30:08', 'R', 0, 'No'),
(43, 4, '101', '100.00', '04-02-2018', '2', 'Sougata', 'Pankaj', '2018-02-02 17:30:08', 'L', 0, 'No'),
(44, 4, '101', '200.00', '05-01-2016', '1', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 'R', 0, 'No'),
(45, 4, '101', '200.00', '07-01-2016', '1', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 'R', 0, 'No'),
(46, 4, '101', '200.00', '07-01-2016', '1', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 'L', 0, 'No'),
(47, 4, '101', '200.00', '15-08-2017', '8', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 'R', 0, 'No'),
(48, 4, '101', '200.00', '15-08-2017', '8', 'Sougata', 'Pankaj', '2018-02-03 02:13:50', 'L', 0, 'No'),
(49, 4, '101', '145.00', '15-02-2018', '2', 'gggg', 'ggg', '2018-02-15 03:56:03', 'R', 0, 'No'),
(50, 4, '101', '100.00', '15-02-2018', '2', 'gggg', 'ggg', '2018-02-15 03:56:03', 'L', 0, 'No'),
(51, 4, '101', '14.00', '09-02-2018', '2', 'gg', 'hh', '2018-02-17 06:35:05', 'R', 0, 'No'),
(52, 4, '101', '12.00', '09-02-2018', '2', 'gg', 'hh', '2018-02-17 06:35:05', 'L', 0, 'No'),
(54, 4, '101', '200.00', '05-02-2018', '2', 'pk', 'pk', '2018-02-19 15:30:22', 'L', 0, 'No'),
(55, 4, '101', '200.00', '05-02-2018', '2', 'pk', 'pk', '2018-02-19 15:32:06', 'L', 0, 'No'),
(56, 4, '101', '50.00', '20-02-2018', '2', 'pk', 'pk', '2018-02-19 16:40:32', 'L', 0, 'No'),
(57, 4, '101', '50.00', '21-02-2018', '2', 'pkp', 'pkp', '2018-02-19 16:41:52', 'L', 0, 'No'),
(58, 4, '101', '200.00', '22-02-2018', '2', 'pl', 'pl', '2018-02-19 16:43:24', 'L', 0, 'No'),
(59, 4, '101', '200.00', '01-03-2018', '3', 'pk', 'pk', '2018-02-19 16:52:14', 'L', 0, 'No'),
(60, 4, '101', '100.00', '02-03-2018', '3', 'pk', 'pk', '2018-02-19 17:05:50', 'L', 0, 'No'),
(61, 4, '101', '99.00', '03-02-2018', '2', 'pkp', 'pk', '2018-02-19 17:06:54', 'L', 0, 'No'),
(62, 4, '101', '300.00', '03-02-2018', '2', 'pkp', 'pkp', '2018-02-19 17:07:48', 'L', 0, 'No'),
(63, 4, '101', '400.00', '03-03-2018', '3', 'kp', 'pk', '2018-02-19 17:08:38', 'L', 0, 'No'),
(64, 4, '101', '400.00', '03-03-2018', '3', 'pk', 'pk', '2018-02-19 17:11:14', 'L', 0, 'No'),
(65, 4, '101', '700.00', '03-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:12:16', 'L', 0, 'No'),
(66, 4, '101', '300.00', '01-02-2018', '2', 'pkp', 'pkp', '2018-02-19 17:15:49', 'L', 0, 'No'),
(67, 4, '101', '500.00', '03-03-2018', '3', 'pkp', 'pkp', '2018-02-19 17:15:49', 'L', 0, 'No'),
(68, 4, '101', '450.00', '04-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:15:49', 'L', 0, 'No'),
(69, 4, '101', '50.00', '12-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:18:13', 'L', 0, 'No'),
(70, 4, '101', '450.00', '12-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:19:40', 'L', 0, 'No'),
(71, 4, '101', '50.00', '13-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:21:00', 'L', 0, 'No'),
(72, 4, '101', '50.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:26:59', 'L', 0, 'No'),
(73, 4, '101', '450.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:31:12', 'L', 0, 'No'),
(74, 4, '101', '50.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:31:38', 'L', 0, 'No'),
(75, 4, '101', '450.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:32:26', 'L', 0, 'No'),
(76, 4, '101', '50.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:32:36', 'L', 0, 'No'),
(77, 4, '101', '100.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:34:13', 'L', 0, 'No'),
(78, 4, '101', '200.00', '14-04-2018', '4', 'pkp', 'pkp', '2018-02-19 17:52:04', 'L', 0, 'No'),
(79, 4, '101', '200.00', '05-04-2018', '4', 'vv', 'vv', '2018-02-19 17:53:36', 'L', 0, 'No'),
(80, 4, '101', '200.00', '05-04-2018', '4', 'vv', 'vv', '2018-02-19 17:54:49', 'L', 0, 'No'),
(81, 4, '101', '200.00', '05-04-2018', '4', 'vv', 'vv', '2018-02-19 17:57:42', 'L', 0, 'No'),
(82, 4, '101', '300.00', '05-04-2018', '4', 'vv', 'vv', '2018-02-19 18:00:52', 'L', 0, 'No'),
(83, 4, '101', '300.00', '05-04-2018', '4', 'vv', 'vv', '2018-02-19 18:02:31', 'L', 0, 'No'),
(84, 4, '101', '300.00', '05-04-2018', '4', 'vv', 'vv', '2018-02-19 18:05:39', 'L', 0, 'No'),
(85, 4, '101', '200.00', '20-04-2018', '4', 'pkp', 'kk', '2018-02-19 18:06:20', 'L', 0, 'No'),
(86, 4, '101', '200.00', '12-04-2018', '4', 'kk', 'kk', '2018-02-19 18:09:34', 'L', 0, 'No'),
(87, 4, '101', '300.00', '20-04-2018', '4', 'kk', 'kk', '2018-02-19 18:10:16', 'L', 0, 'No'),
(88, 4, '101', '500.00', '03-05-2018', '5', 'kl', 'kl', '2018-02-19 18:10:59', 'L', 0, 'No'),
(89, 4, '101', '25000.00', '18-05-2018', '5', 'pkp', 'pkp', '2018-03-18 14:16:44', 'L', 0, 'No'),
(90, 5, '103', '500.00', '01-02-2018', '2', 'pankaj', 'sougata', '2018-03-18 14:43:48', 'L', 0, 'No'),
(91, 5, '103', '1500.00', '01-03-2018', '3', 'pankaj', 'sougata', '2018-03-18 14:43:49', 'L', 0, 'No'),
(92, 5, '103', '1500.00', '12-04-2018', '4', 'pankaj', 'sougata', '2018-03-18 14:43:49', 'L', 0, 'No'),
(93, 5, '103', '2000.00', '18-05-2018', '5', 'pankaj', 'sougata', '2018-03-18 14:43:49', 'L', 0, 'No'),
(94, 5, '103', '300.00', '01-03-2018', '3', 'pankaj', 'sougata', '2018-03-18 14:51:32', 'R', 0, 'No'),
(95, 5, '103', '4000.00', '21-06-2018', '6', 'pankaj', 'sougata', '2018-03-18 14:56:33', 'L', 0, 'No'),
(96, 5, '103', '2000.00', '20-07-2018', '7', 'pankaj', 'sougata', '2018-03-18 14:57:28', 'L', 0, 'No'),
(107, 5, '103', '1000.00', '02-08-2018', '8', 'pankaj', 'sougata', '2018-03-18 19:17:14', 'L', 0, 'No'),
(108, 6, '3703', '1400.00', '07-04-2016', '4', 'pk', 'pk', '2018-03-18 20:00:43', 'L', 0, 'No'),
(109, 6, '3703', '1500.00', '02-05-2016', '5', 'pk', 'pk', '2018-03-18 20:00:43', 'L', 0, 'No'),
(118, 6, '3703', '11500.00', '14-07-2016', '7', 'pk', 'pk', '2018-03-19 01:54:04', 'L', 0, 'No'),
(120, 6, '3703', '15500.00', '12-08-2016', '8', 'pk', 'pk', '2018-03-19 02:09:07', 'L', 0, 'No'),
(127, 6, '3703', '15000.00', '23-09-2016', '9', 'pk', 'pk', '2018-03-19 02:37:19', 'L', 0, 'No'),
(128, 6, '3703', '15000.00', '21-10-2016', '10', 'pk', 'pk', '2018-03-19 02:40:48', 'L', 0, 'No'),
(129, 6, '3703', '14000.00', '17-11-2016', '11', 'pk', 'pk', '2018-03-19 02:40:48', 'L', 0, 'No'),
(130, 6, '3703', '15500.00', '22-12-2016', '12', 'pk', 'pk', '2018-03-19 02:40:48', 'L', 0, 'No');

-- --------------------------------------------------------

--
-- Table structure for table `trem_master`
--

CREATE TABLE `trem_master` (
  `id` int(11) NOT NULL,
  `term` varchar(255) NOT NULL,
  `termunit` varchar(255) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `trem_master`
--

INSERT INTO `trem_master` (`id`, `term`, `termunit`, `status`) VALUES
(1, '3', 'Months', 0),
(2, '6', 'Months', 0),
(3, '12', 'Months', 0),
(4, '18', 'Months', 1),
...
(4, 'admin', '$2a$08$4fEU85.E6aGLVYXPqqMjKeOGwqW/VCKTI.zZnTG0WQ0JkvCBWKNzq', 'patrapankaj36@gmail.com', 1, 0, NULL, NULL, NULL, NULL, '66b3e97a57fc01ec234d1474a2c07ebf', '::1', '2018-08-01 18:09:58', '2018-01-16 04:23:24', '2018-08-01 16:09:58');
...
--
-- Indexes for table `customer_contact_master`
--
ALTER TABLE `customer_contact_master`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `customer_loan_master`
--
ALTER TABLE `customer_loan_master`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `customer_recurring_master`
--
ALTER TABLE `customer_recurring_master`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dd_settlement`
--
ALTER TABLE `dd_settlement`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `interest_calculate`
--
ALTER TABLE `interest_calculate`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `loan_take`
--
ALTER TABLE `loan_take`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `recurring_master`
--
ALTER TABLE `recurring_master`
...
--
-- Indexes for table `settlement_from_insurance`
--
ALTER TABLE `settlement_from_insurance`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `trem_master`
--
ALTER TABLE `trem_master`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `customer_contact_master`
--
ALTER TABLE `customer_contact_master`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `customer_loan_master`
--
ALTER TABLE `customer_loan_master`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `customer_recurring_master`
--
ALTER TABLE `customer_recurring_master`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dd_settlement`
--
ALTER TABLE `dd_settlement`
...
--
-- AUTO_INCREMENT for table `interest_calculate`
--
ALTER TABLE `interest_calculate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `loan_master`
  MODIFY `loan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
-- AUTO_INCREMENT for table `loan_take`
--
ALTER TABLE `loan_take`
...
--
-- AUTO_INCREMENT for table `recurring_master`
--
ALTER TABLE `recurring_master`
  MODIFY `recurring_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `settlement_from_insurance`
--
ALTER TABLE `settlement_from_insurance`
...
--
ALTER TABLE `transaction`
  MODIFY `trans_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT for table `trem_master`
--
ALTER TABLE `trem_master`
